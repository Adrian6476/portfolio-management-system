...
// Check summary metrics - updated to match new component structure
...
expect(screen.getByText('Unrealized gains/losses')).toBeInTheDocument()
...
// Check individual holding share quantities in top holdings section
